...
model = YOLO('C:\\Users\\Carl\\Barong Tagalog Design Classification\\article1model.pt')
...
print("\nPrediction summary saved to 'prediction_summary.csv'.")
...
plt.savefig('confusion_matrix_yolov8.png')
